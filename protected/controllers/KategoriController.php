...
class KategoriController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$dataKategori = Kategori::model()->findAll();
	...
	public function actionUpdatedata()
	{
		...
		$dataKategori = Kategori::model()->findBypk($id);
		
		if($dataKategori){
			$dataKategori->kategori_nama 	= $nama;
			$dataKategori->kategori_update 	= date('Y-m-d H:i:s');
			$dataKategori->save();
		}
	}
