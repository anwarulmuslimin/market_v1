...
<script type="text/javascript">
    ...
    function tampil_data(){
         $.ajax({
            type        : "POST",
            url         : "<?php echo Yii::app()->createUrl('market/tampil');?>",
            cache       : false,
    ...
    function hapus(id){
        if (confirm('Apakah anda akan melanjutkan menghapus?')) {
            $.ajax({
                type        : "POST",
                url         : "<?php echo Yii::app()->createUrl('market/remove');?>",
                data        : "id="+id,
                cache       : false,
                success     :function(html){
                    tampil_data();
    ...
    function edit(id){
        $.ajax({
            type        : "POST",
            url         : "<?php echo Yii::app()->createUrl('market/edit');?>",
            data        : "id="+id,
            cache       : false,
            success     :function(html){
                $("#body_data").html(html);
    ...
    function simpan(){
        var dataString    = " id="+$("#id_market").val()+
                        "&kode="+$("#kode").val()+
                        "&nama="+$("#nama").val()+
                        "&tipe="+$("#tingkat").val();
        ...
        $.ajax({
            type        : "POST",
            url         : "<?php echo Yii::app()->createUrl('market/updatedata');?>",
            data        : dataString,
            cache       : false,
            success     : function(html){
                tampil_data();
